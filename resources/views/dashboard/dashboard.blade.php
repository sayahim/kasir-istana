...
<head>
  ...
  <!-- <link rel="styledashboard" type="text/css" href="{{ asset('/css/app.css') }}"> -->
  ...
  <link href="bootstrap/dashboard/css/sb-admin-2.min.css" rel="stylesheet">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="{{ route('dashboard_kasir')}}">
