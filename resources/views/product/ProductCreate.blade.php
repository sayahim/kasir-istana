          ...
          <div class="mt-10 ">
            ...
            <div class="justify-content-between">
                  ...
                  <a href="{{ route('product')}}" class="btn btn-light btn-icon-split m-b-10">
                    ...
                    <span class="h3 m-l-20 text-gray-800 font-weight-bold">Input Produk</span>
                ...
                <div class="p-l-50 p-r-50 p-b-30 p-t-30">
                  ...
                  <form method="post" action="{{ route('input_product')}}" class="user">
                    ...
                    <div class="form-group">
                      <input name="name" class="form-control form-control-rounded padding-layout-10" aria-describedby="emailHelp" placeholder=" Nama Produk">
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                        <input name="price_buy" class="form-control form-control-rounded"  placeholder="Harga Beli">
                        </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                        <input name="price_sell" class="form-control form-control-rounded" placeholder="Harga Jual">
                        </div>
                    ...
                    <div class="form-group"> 
                      ...
                      <textarea name="description" type="description" class="form-description" rows="5" placeholder="Deskripsi"></textarea>
                    </div>
                    <div class="form-group">
